"""Module de génération d'un tableau de bord PDF via l'API Mistral."""
...
FICHIER_CSV = "data/csv/election-municipale-2026-2nd-tour-resultats.csv"

FICHIER_HTML_SORTIE = "Mistral_Dashboard.html"
FICHIER_PDF_SORTIE = "Mistral_Dashboard.pdf"


def generer_rapport_avec_mistral(csv_path, html_output_path, pdf_output_path):
    """Génère un rapport stratégique en PDF à l'aide de l'IA Mistral.
    ...
    nb_lignes = len(df)
    echantillon = df.head(4).to_dict(orient="records")
    ...
    prompt = (
        ...
        "- Thématique : Données territoriales (Grand Paris Sud).\n"
        "- Territoire cible : Les 23 communes de l'agglomération.\n"
        ...
        "2. KPIs : Déduis 3 à 4 indicateurs majeurs et place-les en haut sous forme de 'Cartes' alignées horizontalement.\n"
        "3. Focus Territorial : Crée une section détaillant les communes.\n"
    ...
    print("Demande de génération du code HTML à Mistral...")
    ...
    html_genere = response.choices[0].message.content
...
if __name__ == "__main__":
    generer_rapport_avec_mistral(FICHIER_CSV, FICHIER_HTML_SORTIE, FICHIER_PDF_SORTIE)